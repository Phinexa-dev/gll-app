  ...
  void _validateForm() async {
    ...
    if (selectedChallenges == null || selectedChallenges.isEmpty) {
      ...
      if (selectedChallenges.contains("Other") &&
        ...
        isValid = false;
        errorMessage += "- Other challenges elaboration\n";
      } else {
        _challengesOtherError.value = null;
      }
    }

    if (radioResponses["Did you receive adequate support from the sponsoring organization or your mentors?"] ==
        null) {
      _supportError.value = 'Please select an option';
      isValid = false;
      errorMessage += "- Adequate support\n";
    } else {
    ...
    if (receivedSupport == false &&
      ...
      isValid = false;
      errorMessage += "- Additional support details\n";
    } else {
