...
final eventProvider = Provider<List<Event>>((ref) {
  return [
    ...
    Event(
      ...
      ledBy: 'Master Trainers Macedonia',
      subEvents: [
        SubEvent(
            ...
            description: RichText(
              text: TextSpan(
                children: [
                  ...
                  TextSpan(
                    text:
                        " certification! Learn to facilitate the Academy and inspire others through the Global Learning Lab.",
                  ),
                ],
              ),
            )),
    ...
    Event(
      ...
      subTitle: 'Empowering Tomorrow’s Leaders Today!',
      ledBy:
          'Global Master Trainers from Macedonia and the U.S., this immersive experience takes place in Sarajevo, Bosia',
      subEvents: [
        SubEvent(
            ...
            description: RichText(
              text: TextSpan(
                children: [
                  TextSpan(
                    text:
                        "Participate in the Leadership Academy to develop essential leadership skills, engage in hands-on learning, and design your own Sustainable Impact Project (SIP).",
                  ),
                ],
              ),
            )),
    ...
    Event(
      ...
      subTitle: 'Empowering Tomorrow’s Leaders Today!',
      ledBy:
          'Global Master Trainers from Nepal, India, Macedonia, and the U.S., this immersive experience takes place at the world-class HMTX Headquarters.',
      subEvents: [
        SubEvent(
