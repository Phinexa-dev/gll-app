...
class _SurveyApi implements SurveyApi {
  ...
  Future<SurveyResponse> submitPreSurvey(
    int eventId,
    PreSurveyRequest request,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<SurveyResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/user-event/survey/${eventId}',
    ...
    late SurveyResponse _value;
    try {
      _value = SurveyResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<SurveyResponse> submitPostSurvey(
    ...
    final _options = _setStreamType<SurveyResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/user-event/post-survey/${eventId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
